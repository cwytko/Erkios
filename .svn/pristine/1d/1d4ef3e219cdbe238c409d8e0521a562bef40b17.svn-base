...
public class OPWANClient {
	...
	public OPWANClient() 
		...
		setStubOPWAN((OPWANInterface)registry.lookup("OPWANInterface"));
		*/
		...
		try {
			...
			// TODO: handle exception
			System.err.println(ras.interfaces.Utilities.separator3+"OPWANClient err:"+e.getMessage());
		}
	}
}
